...
/**
 * @file
 * @brief Implementation of the private Win32 + DX11 host used by `client_mockup`.
 */
...
struct Win32Dx11ImGuiHost::Impl
{
    ...
    static constexpr const wchar_t* kWindowClassName = L"MfdClientMockupWin32Dx11Host";
