...
/**
 * @file
 * @brief Private Win32 + DX11 host used by `client_mockup`.
 */
 ...
 *
 * @details This host is intentionally private to `client_mockup`. It replaces
 * the previous raylib window shell while keeping the mockup business logic
 * entirely focused on the public client/runtime APIs.
 */
...
public:
    ...
    struct Config
    {
        ...
        int minWidth = 1180;
        int minHeight = 720;
        std::string title = "Client Mockup";
    };
