...
/**
 * @file
 * @brief Implementation of the Demo HUD generated-UI adapter.
 */
...
void HideAirToAirGunReticles(demo_hud_ui::HUDMockupPage& hud)
{
...
void ApplyAttitude(demo_hud_ui::HUDMockupPage& hud, const HudFrame& frame)
{
...
void ApplyAirData(demo_hud_ui::HUDMockupPage& hud,
...
void ApplyAirToAirMissile(demo_hud_ui::HUDMockupPage& hud, const HudFrame& frame)
{
...
void ApplyAirToAirGun(demo_hud_ui::HUDMockupPage& hud, const HudFrame& frame)
{
...
void ApplyAirToGroundCcip(demo_hud_ui::HUDMockupPage& hud, const HudFrame& frame)
{
...
void ApplyAirToGroundStrafe(demo_hud_ui::HUDMockupPage& hud, const HudFrame& frame)
{
    const HudGunFrame& gun = frame.gun;
...
void ApplyLandingApproach(demo_hud_ui::HUDMockupPage& hud, const HudInputSample& input, const HudFrame& frame)
{
...
void ApplyIls(demo_hud_ui::HUDMockupPage& hud, const HudFrame& frame)
{
...
void ApplyWeapon(demo_hud_ui::HUDMockupPage& hud, const HudFrame& frame)
{
...
void DemoHudController::Populate(demo_hud_ui::DemoHudUi& ui, const HudInputSample& input) const
{
    // HUD input contract:
    ...
    const HudFrame frame = demo_hud::BuildHudFrame(input);

    demo_hud_ui::HUDMockupPage& hud = ui.HUD();
