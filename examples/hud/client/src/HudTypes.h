...
/**
 * @file
 * @brief Semantic input and projected-frame types for the reusable HUD core.
 */
...
{
/**
 * @defgroup hud_integration HUD integration API
 ...
 *
 * Deviation signs follow the HUD command convention used by this HUD client:
