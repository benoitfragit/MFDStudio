...
| [Editor Reticle Extraction Workflow](./editor_reticle_extraction.md) | you are changing how selected page reticles are flattened into one reusable library template and replaced in-place on the page |
