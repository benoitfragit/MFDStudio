...
constexpr std::array<TutorialStepDefinition, static_cast<std::size_t>(TutorialStepId::Count)> kTutorialSteps {{
    ...
    {TutorialStepKind::UiAction,
     ...
     "Open the page-preview View menu and toggle Sidebar under Panels to discover that the side panels can be hidden to focus on the page. Re-open the View menu to bring it back whenever you need it.",
     "page_preview_view_menu",
     nullptr,
     nullptr,
     nullptr},
