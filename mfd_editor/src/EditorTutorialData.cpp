...
constexpr std::array<TutorialStepDefinition, static_cast<std::size_t>(TutorialStepId::Count)> kTutorialSteps {{
    ...
    {TutorialStepKind::UiAction,
     ...
     "Still on Page1, keep the suggested strobe name `Strobe1`, choose `mfd_tutorial_strobe_cursor`, then click `Add strobe` again. Page1 now exposes two activable strobes so the generated client can switch at runtime and later return to the previous one.",
