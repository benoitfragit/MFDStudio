...
expect_exists("Client API transitive page-name header" "${client_sdk_root}/include/mfd/model/PageName.h")
expect_exists("Client API transitive reticle header" "${client_sdk_root}/include/mfd/model/Reticle.h")
...
expect_missing("Client API internal model static library" "${client_sdk_root}/libs/${TOOLSET}/${PLATFORM}/${BUILD_CONFIG}/mfd_model.lib")
expect_missing("Client API internal transport static library" "${client_sdk_root}/libs/${TOOLSET}/${PLATFORM}/${BUILD_CONFIG}/mfd_transport.lib")
expect_missing("Client API runtime-only command processor header" "${client_sdk_root}/include/mfd/control/CommandProcessor.h")
expect_missing("Client API runtime bridge header" "${client_sdk_root}/include/mfd/control/UdpRuntimeBridge.h")
expect_missing("Client API runtime strobe feedback header" "${client_sdk_root}/include/mfd/control/StrobeFeedback.h")
expect_missing("Client API JSON loader header" "${client_sdk_root}/include/mfd/io/JsonLoader.h")
expect_missing("Client API UDP channel implementation header" "${client_sdk_root}/include/mfd/ipc/UdpChannel.h")
expect_missing("Client API render facade header" "${client_sdk_root}/include/mfd/render/MfdRenderer.h")
expect_missing("Client API scene registry header" "${client_sdk_root}/include/mfd/runtime/SceneRegistry.h")
