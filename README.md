...
- `View > Layer Inspector` stays off by default, then opens one docked panel on the left of the page preview with per-layer thumbnails, focus selection, and dimmed non-focused layers without changing the JSON schema
